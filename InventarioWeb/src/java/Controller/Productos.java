    ...
    String estado_pro = request.getParameter("estado");
         ...
         */                                                              
         ...
         if(estado.equals("listar")){
             ...
             RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/Vista-Productos/EditarPro.jsp?id="+id_pro+"&&nombre="+nombre_pro+"&&stock="+stock_pro+"&&precio="+precio_pro+"&&unidad="+unidadM+"&&estado="+estado_pro);
             dispatcher.forward(request, response);
