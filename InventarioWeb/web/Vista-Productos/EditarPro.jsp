...
<html>
    ...
    <body>
        ...
        <div class="col-auto bg-gray p-5 text-center">
            ...
            <form action="ActualizarPro.do" method="post">
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    <label for="" class="col-sm-2 col-form-label">Nombre Producto:</label>
                    <div class="col-sm-10">
                        <input type="text" value='<%= nombre_pro%>' name="nombre" id="nombre" class="form-control" placeholder="Nombre Producto" required="true">
                    </div>
                </div>
                    <div class="mb-3 row">
                    <label for="" class="col-sm-2 col-form-label">Stock Produto:</label>
                    <div class="col-sm-10">
                        <input type="text" value='<%= stock_pro%>' name="stock" id="stock" class="form-control" placeholder="Stock de producto" required="true">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="" class="col-sm-2 col-form-label">Precio Producto:</label>
                    <div class="col-sm-10">
                        <input type="text" value='<%= precio_pro%>' name="precio" id="precio" class="form-control" placeholder="Precio de producto" required="true">
                    </div>
                </div>
                    <div class="mb-3 row">
                    <label for="" class="col-sm-2 col-form-label">Unidad de medida:</label>
                    <div class="col-sm-10">
                        <input type="text" value='<%= unidad_pro%>' name="Unidad" id="Unidad" class="form-control" placeholder="Unidad" required="true">
                    </div>
                </div>
                     <div class="mb-3 row">
                    <label for="" class="col-sm-2 col-form-label">Estado de producto:</label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <button onclick="EventoAlert()" type="submit" name="send" class="btn btn-success">Actualizar Producto</button>
                </div>
            </form>
