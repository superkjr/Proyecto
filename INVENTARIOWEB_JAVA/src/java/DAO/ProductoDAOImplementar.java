...
public class ProductoDAOImplementar implements ProductosDAO{
    ...
    public boolean guardarPro(Producto producto) {
        ...
        try{
            ...
            miSQL.append(producto.getNom_producto() + "', ").append(producto.getStock() + "', ").append(producto.getPrecio() + "', ").append(producto.getUnidadMedida() + "', ").append(producto.getEstado() + "', ").append(producto.getCategoria());
            miSQL.append(");");
